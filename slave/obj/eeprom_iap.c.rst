      ...
      000019                        511 	.ds 1
      00001A                        512 _iap_cmd_PARM_3:
      00001A                        513 	.ds 1
      00001B                        514 _iap_cmd_PARM_4:
      00001B                        515 	.ds 1
      00001C                        516 _iap_cmd_PARM_5:
      00001C                        517 	.ds 1
                                    518 ;--------------------------------------------------------
                                    ...
                                    580 ;------------------------------------------------------------
                                    581 ;	../lib/eeprom_iap.c:9: void iap_cmd(char au8IAPCN, char au8IAPAH, char au8IAPAL, char au8IAPFD, char au8Flag)
                                    582 ;	-----------------------------------------
      ...
      0020FC                        585 _iap_cmd:
                           ...
                           000001   592 	ar1 = 0x01
                           000000   593 	ar0 = 0x00
      0020FC AF 82            [24]  594 	mov	r7,dpl
                                    595 ;	../lib/eeprom_iap.c:11: set_IAPEN; // Enable IAPEN
                                    596 ;	assignBit
      0020FE A2 AF            [12]  597 	mov	c,_EA
      002100 92 00            [24]  598 	mov	_BIT_TMP,c
                                    599 ;	assignBit
      002102 C2 AF            [12]  600 	clr	_EA
      002104 75 C7 AA         [24]  601 	mov	_TA,#0xaa
      002107 75 C7 55         [24]  602 	mov	_TA,#0x55
      00210A 43 9F 01         [24]  603 	orl	_CHPCON,#0x01
                                    604 ;	assignBit
      00210D A2 00            [12]  605 	mov	c,_BIT_TMP
      00210F 92 AF            [24]  606 	mov	_EA,c
                                    607 ;	../lib/eeprom_iap.c:13: if (au8Flag) {
      002111 E5 1C            [12]  608 	mov	a,_iap_cmd_PARM_5
      002113 60 13            [24]  609 	jz	00102$
                                    610 ;	../lib/eeprom_iap.c:14: set_APUEN;							//enable APROM update
                                    611 ;	assignBit
      002115 A2 AF            [12]  612 	mov	c,_EA
      002117 92 00            [24]  613 	mov	_BIT_TMP,c
                                    614 ;	assignBit
      002119 C2 AF            [12]  615 	clr	_EA
      00211B 75 C7 AA         [24]  616 	mov	_TA,#0xaa
      00211E 75 C7 55         [24]  617 	mov	_TA,#0x55
      002121 43 A5 01         [24]  618 	orl	_IAPUEN,#0x01
                                    619 ;	assignBit
      002124 A2 00            [12]  620 	mov	c,_BIT_TMP
      002126 92 AF            [24]  621 	mov	_EA,c
      002128                        622 00102$:
                                    623 ;	../lib/eeprom_iap.c:17: IAPAL = au8IAPAL;
      002128 85 1A A6         [24]  624 	mov	_IAPAL,_iap_cmd_PARM_3
                                    625 ;	../lib/eeprom_iap.c:18: IAPAH = au8IAPAH;
      00212B 85 19 A7         [24]  626 	mov	_IAPAH,_iap_cmd_PARM_2
                                    627 ;	../lib/eeprom_iap.c:19: IAPFD = au8IAPFD;
      00212E 85 1B AE         [24]  628 	mov	_IAPFD,_iap_cmd_PARM_4
                                    629 ;	../lib/eeprom_iap.c:20: IAPCN = au8IAPCN;
      002131 8F AF            [24]  630 	mov	_IAPCN,r7
                                    631 ;	../lib/eeprom_iap.c:22: set_IAPGO; // Trig set IAPGO
                                    632 ;	assignBit
      002133 A2 AF            [12]  633 	mov	c,_EA
      002135 92 00            [24]  634 	mov	_BIT_TMP,c
                                    635 ;	assignBit
      002137 C2 AF            [12]  636 	clr	_EA
      002139 75 C7 AA         [24]  637 	mov	_TA,#0xaa
      00213C 75 C7 55         [24]  638 	mov	_TA,#0x55
      00213F 43 A4 01         [24]  639 	orl	_IAPTRG,#0x01
                                    640 ;	assignBit
      002142 A2 00            [12]  641 	mov	c,_BIT_TMP
      002144 92 AF            [24]  642 	mov	_EA,c
                                    643 ;	../lib/eeprom_iap.c:24: if (au8Flag) {
      002146 E5 1C            [12]  644 	mov	a,_iap_cmd_PARM_5
      002148 60 26            [24]  645 	jz	00105$
                                    646 ;	../lib/eeprom_iap.c:25: clr_APUEN;
                                    647 ;	assignBit
      00214A A2 AF            [12]  648 	mov	c,_EA
      00214C 92 00            [24]  649 	mov	_BIT_TMP,c
                                    650 ;	assignBit
      00214E C2 AF            [12]  651 	clr	_EA
      002150 75 C7 AA         [24]  652 	mov	_TA,#0xaa
      002153 75 C7 55         [24]  653 	mov	_TA,#0x55
      002156 53 A5 FE         [24]  654 	anl	_IAPUEN,#0xfe
                                    655 ;	assignBit
      002159 A2 00            [12]  656 	mov	c,_BIT_TMP
      00215B 92 AF            [24]  657 	mov	_EA,c
                                    658 ;	../lib/eeprom_iap.c:26: clr_IAPEN;
                                    659 ;	assignBit
      00215D A2 AF            [12]  660 	mov	c,_EA
      00215F 92 00            [24]  661 	mov	_BIT_TMP,c
                                    662 ;	assignBit
      002161 C2 AF            [12]  663 	clr	_EA
      002163 75 C7 AA         [24]  664 	mov	_TA,#0xaa
      002166 75 C7 55         [24]  665 	mov	_TA,#0x55
      002169 53 9F FE         [24]  666 	anl	_CHPCON,#0xfe
                                    667 ;	assignBit
      00216C A2 00            [12]  668 	mov	c,_BIT_TMP
      00216E 92 AF            [24]  669 	mov	_EA,c
      002170                        670 00105$:
                                    671 ;	../lib/eeprom_iap.c:28: }
      002170 22               [24]  672 	ret
                                    673 ;------------------------------------------------------------
                                    674 ;Allocation info for local variables in function 'Erase_APROM_Page'
                                    675 ;------------------------------------------------------------
                                    676 ;u16EPAddr                 Allocated to registers r6 r7 
                                    677 ;------------------------------------------------------------
                                    678 ;	../lib/eeprom_iap.c:31: void Erase_APROM_Page(unsigned int u16EPAddr)
                                    679 ;	-----------------------------------------
                                    680 ;	 function Erase_APROM_Page
                                    681 ;	-----------------------------------------
      002171                        682 _Erase_APROM_Page:
      002171 AE 82            [24]  683 	mov	r6,dpl
      002173 AF 83            [24]  684 	mov	r7,dph
                                    685 ;	../lib/eeprom_iap.c:33: iap_cmd(0x22, (u16EPAddr>>8)&0xff, u16EPAddr&0xff, 0xFF, 1);
      002175 8F 19            [24]  686 	mov	_iap_cmd_PARM_2,r7
      002177 8E 1A            [24]  687 	mov	_iap_cmd_PARM_3,r6
      002179 75 1B FF         [24]  688 	mov	_iap_cmd_PARM_4,#0xff
      00217C 75 1C 01         [24]  689 	mov	_iap_cmd_PARM_5,#0x01
      00217F 75 82 22         [24]  690 	mov	dpl,#0x22
                                    691 ;	../lib/eeprom_iap.c:34: }
      002182 02 20 FC         [24]  692 	ljmp	_iap_cmd
                                    693 ;------------------------------------------------------------
                                    ...
                                    698 ;------------------------------------------------------------
                                    699 ;	../lib/eeprom_iap.c:37: void Write_APROM_BYTE(unsigned int u16EPAddr,unsigned char u8EPData)
                                    700 ;	-----------------------------------------
                                    701 ;	 function Write_APROM_BYTE
                                    702 ;	-----------------------------------------
      002185                        703 _Write_APROM_BYTE:
      002185 AE 82            [24]  704 	mov	r6,dpl
      002187 AF 83            [24]  705 	mov	r7,dph
                                    706 ;	../lib/eeprom_iap.c:39: iap_cmd(0x21, (u16EPAddr>>8)&0xff, u16EPAddr&0xff, u8EPData, 1);
      002189 8F 19            [24]  707 	mov	_iap_cmd_PARM_2,r7
      00218B 8E 1A            [24]  708 	mov	_iap_cmd_PARM_3,r6
      00218D 85 10 1B         [24]  709 	mov	_iap_cmd_PARM_4,_Write_APROM_BYTE_PARM_2
      002190 75 1C 01         [24]  710 	mov	_iap_cmd_PARM_5,#0x01
      002193 75 82 21         [24]  711 	mov	dpl,#0x21
                                    712 ;	../lib/eeprom_iap.c:40: }
      002196 02 20 FC         [24]  713 	ljmp	_iap_cmd
                                    714 ;------------------------------------------------------------
                                    ...
                                    719 ;------------------------------------------------------------
                                    720 ;	../lib/eeprom_iap.c:42: UINT16 read_bandgap_value()
                                    721 ;	-----------------------------------------
                                    722 ;	 function read_bandgap_value
                                    723 ;	-----------------------------------------
      002199                        724 _read_bandgap_value:
                                    725 ;	../lib/eeprom_iap.c:45: iap_cmd(0x04,0x00,0x0c,0,0);
      002199 75 19 00         [24]  726 	mov	_iap_cmd_PARM_2,#0x00
      00219C 75 1A 0C         [24]  727 	mov	_iap_cmd_PARM_3,#0x0c
      00219F 75 1B 00         [24]  728 	mov	_iap_cmd_PARM_4,#0x00
      0021A2 75 1C 00         [24]  729 	mov	_iap_cmd_PARM_5,#0x00
      0021A5 75 82 04         [24]  730 	mov	dpl,#0x04
      0021A8 12 20 FC         [24]  731 	lcall	_iap_cmd
                                    732 ;	../lib/eeprom_iap.c:46: BandgapHigh = IAPFD;
      0021AB AF AE            [24]  733 	mov	r7,_IAPFD
                                    734 ;	../lib/eeprom_iap.c:47: iap_cmd(0x04,0x00,0x0d,0,0);
      0021AD 75 19 00         [24]  735 	mov	_iap_cmd_PARM_2,#0x00
      0021B0 75 1A 0D         [24]  736 	mov	_iap_cmd_PARM_3,#0x0d
      0021B3 75 1B 00         [24]  737 	mov	_iap_cmd_PARM_4,#0x00
      0021B6 75 1C 00         [24]  738 	mov	_iap_cmd_PARM_5,#0x00
      0021B9 75 82 04         [24]  739 	mov	dpl,#0x04
      0021BC C0 07            [24]  740 	push	ar7
      0021BE 12 20 FC         [24]  741 	lcall	_iap_cmd
      0021C1 D0 07            [24]  742 	pop	ar7
                                    743 ;	../lib/eeprom_iap.c:48: BandgapLow = IAPFD;
      0021C3 E5 AE            [12]  744 	mov	a,_IAPFD
                                    745 ;	../lib/eeprom_iap.c:49: BandgapLow = BandgapLow&0x0F;
      0021C5 54 0F            [12]  746 	anl	a,#0x0f
      0021C7 FE               [12]  747 	mov	r6,a
                                    748 ;	../lib/eeprom_iap.c:50: clr_IAPEN; // Disable IAPEN
                                    749 ;	assignBit
      0021C8 A2 AF            [12]  750 	mov	c,_EA
      0021CA 92 00            [24]  751 	mov	_BIT_TMP,c
                                    752 ;	assignBit
      0021CC C2 AF            [12]  753 	clr	_EA
      0021CE 75 C7 AA         [24]  754 	mov	_TA,#0xaa
      0021D1 75 C7 55         [24]  755 	mov	_TA,#0x55
      0021D4 53 9F FE         [24]  756 	anl	_CHPCON,#0xfe
                                    757 ;	assignBit
      0021D7 A2 00            [12]  758 	mov	c,_BIT_TMP
      0021D9 92 AF            [24]  759 	mov	_EA,c
                                    760 ;	../lib/eeprom_iap.c:51: return (BandgapHigh<<4)+BandgapLow;
      0021DB E4               [12]  761 	clr	a
      0021DC C4               [12]  762 	swap	a
      0021DD 54 F0            [12]  763 	anl	a,#0xf0
      0021DF CF               [12]  764 	xch	a,r7
      0021E0 C4               [12]  765 	swap	a
      0021E1 CF               [12]  766 	xch	a,r7
      0021E2 6F               [12]  767 	xrl	a,r7
      0021E3 CF               [12]  768 	xch	a,r7
      0021E4 54 F0            [12]  769 	anl	a,#0xf0
      0021E6 CF               [12]  770 	xch	a,r7
      0021E7 6F               [12]  771 	xrl	a,r7
      0021E8 FD               [12]  772 	mov	r5,a
      0021E9 7C 00            [12]  773 	mov	r4,#0x00
      0021EB EE               [12]  774 	mov	a,r6
      0021EC 2F               [12]  775 	add	a,r7
      0021ED F5 82            [12]  776 	mov	dpl,a
      0021EF EC               [12]  777 	mov	a,r4
      0021F0 3D               [12]  778 	addc	a,r5
      0021F1 F5 83            [12]  779 	mov	dph,a
                                    780 ;	../lib/eeprom_iap.c:52: }
      0021F3 22               [24]  781 	ret
                                    782 ;------------------------------------------------------------
                                    ...
                                    787 ;------------------------------------------------------------
                                    788 ;	../lib/eeprom_iap.c:54: UINT8 read_uid(UINT8 au8Idx)
                                    789 ;	-----------------------------------------
                                    790 ;	 function read_uid
                                    791 ;	-----------------------------------------
      0021F4                        792 _read_uid:
      0021F4 85 82 1A         [24]  793 	mov	_iap_cmd_PARM_3,dpl
                                    794 ;	../lib/eeprom_iap.c:57: iap_cmd(0x04,0x00,au8Idx,0,0);
      0021F7 75 19 00         [24]  795 	mov	_iap_cmd_PARM_2,#0x00
      0021FA 75 1B 00         [24]  796 	mov	_iap_cmd_PARM_4,#0x00
      0021FD 75 1C 00         [24]  797 	mov	_iap_cmd_PARM_5,#0x00
      002200 75 82 04         [24]  798 	mov	dpl,#0x04
      002203 12 20 FC         [24]  799 	lcall	_iap_cmd
                                    800 ;	../lib/eeprom_iap.c:58: u8Uid = IAPFD;
      002206 85 AE 82         [24]  801 	mov	dpl,_IAPFD
                                    802 ;	../lib/eeprom_iap.c:59: clr_IAPEN; // Disable IAPEN
                                    803 ;	assignBit
      002209 A2 AF            [12]  804 	mov	c,_EA
      00220B 92 00            [24]  805 	mov	_BIT_TMP,c
                                    806 ;	assignBit
      00220D C2 AF            [12]  807 	clr	_EA
      00220F 75 C7 AA         [24]  808 	mov	_TA,#0xaa
      002212 75 C7 55         [24]  809 	mov	_TA,#0x55
      002215 53 9F FE         [24]  810 	anl	_CHPCON,#0xfe
                                    811 ;	assignBit
      002218 A2 00            [12]  812 	mov	c,_BIT_TMP
      00221A 92 AF            [24]  813 	mov	_EA,c
                                    814 ;	../lib/eeprom_iap.c:60: return u8Uid;
                                    815 ;	../lib/eeprom_iap.c:61: }
      00221C 22               [24]  816 	ret
                                    817 	.area CSEG    (CODE)
                                    818 	.area CONST   (CODE)
